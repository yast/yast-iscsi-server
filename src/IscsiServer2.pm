...
sub Read {
    ...
    my $caption = __("Initializing iscsi-server Configuration");
...
sub Write {
    ...
    # IscsiServer read dialog caption
    my $caption = __("Saving iscsi-server Configuration");
